...
const chapters: Chapter[] = [
  ...
  {href: '/docs/04-server-management', title: 'ابزار سرور', text: 'آماده‌سازی اولیه، FFmpeg، Chromium و ClamAV'},
  ...
  {href: '/docs/11-networking', title: 'شبکه و SSL', text: 'DNS، وصل کردن دامنه، Let’s Encrypt و گواهی پولی'},
