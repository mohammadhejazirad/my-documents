...
اگر محصول به‌جای بستهٔ توزیع، Chrome for Testing و مسیر Puppeteer می‌خواهد، نصب از مخزن عمومی تیم در [Google Chrome روی سرور](./google-chrome) است. هر دو را همزمان به عنوان مرورگر پیش‌فرض برنامه صدا نزنید.
